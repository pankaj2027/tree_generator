...
def main():
    # len(sys.argv) == 1 and os.getcwd() or sys.argv[1]      #  genererate tree structure for current directory
	directory = '/home/user/djangoproject/djangoall-20210113T091003Z-001/djangoall/gs34'                                 # enter the directory 
	tree(directory)
